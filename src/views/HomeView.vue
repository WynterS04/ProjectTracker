...
const viewAll = computed(() => viewType.value === 'all')
const viewSummary = computed(() => viewType.value === 'summary')
</script>
    ...
    <div class="page-wrapper" role="main">
        ...
        <div class="top-bar">
            <div class="project-view">
                ...
                <button :class="{selectedView: viewAll}" data-test="all-projects-button" @click="viewType = 'all';">All Projects</button>
                <button :class="{selectedView: viewSummary}" data-test="project-summary-button" @click="viewType = 'summary';">Summary</button>
            </div>
            ...
            <div class="user-actions">
                <!-- Filtering By Status -->
                    ...
                    <div class="status-filter">
                        ...
                        <select aria-label="Status filter" data-test="status-select" v-model="status">
                    ...
                    <div class="search">
                        ...
                        <div class="search-project">
                            <input id="search-bar" v-model="searchTerm" @input="arrayToDisplay = store.searchByName(searchTerm)" type="search" placeholder="Search Project Name">
                        </div>
                    </div>
            </div>
        </div>
...
.project-view {
    ...
    gap: 0.6rem;
    border-radius: 5px;
    padding: clamp(0.1rem, 1vw, 0.36rem) clamp(0.1rem, 1vw, 0.3rem);
}
.project-view button {
    border: transparent;
...
.project-view button.selectedView {
    background-color: white;
    color: black;
    border-radius: 5px;
    padding: 5px 13px;
...
#search-bar {
    ...
    font-size: clamp(0.5rem, 2vw, 1.2rem);
    font-weight: lighter;
    padding-right: clamp(0.8rem, 2vw, 2.5rem);
}
</style>
